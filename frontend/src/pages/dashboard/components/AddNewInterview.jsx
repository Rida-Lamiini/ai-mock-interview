...
function AddNewInterview() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (aiResult) {
        await sendPostRequest("/mock-interviews", interviewData);
        setOpenDialog(false);
  ...
  return (
    <div>
      <div
        className="p-10 transition-all border rounded-lg cursor-pointer bg-secondary hover:scale-105 hover:shadow-sm"
